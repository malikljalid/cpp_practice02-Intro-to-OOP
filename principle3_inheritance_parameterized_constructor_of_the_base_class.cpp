...
int main(void)
{
    ...
    std::cout << Zakaria.getTitle() << std::endl;
    std::cout << Zakaria.getDepartement() << std::endl;
    std::cout << Zakaria.getSalary() << std::endl;
    ...
    return (0);   // but how can we solve clsemployee print() issue?
}
