...
class clsDeveloper : public clsEmployee
{
    ...
    clsDeveloper(void)
    {
        _MainProgrammingLanguage = "No PL";
    }

    clsDeveloper(short int ID, std::string FirstName, std::string LastName, std::string Email, std::string Phone, std::string Title, std::string Departement, int Salary, std::string mainPL) : clsEmployee(ID, FirstName, LastName, Email, Phone, Title, Departement, Salary)
    {
        _MainProgrammingLanguage = mainPL;
    }
    std::string getMainProgrammingLanguage(void)
    {
        return (_MainProgrammingLanguage);
    }

    void setMainProgrammingLanguage(std::string mainPL)
    {
        _MainProgrammingLanguage = mainPL;
    }
    ...
    void print(void)
    {
        ...
        std::cout << "Depratement : " << getDepartement() << std::endl;
...
int main(void)
{
    clsDeveloper Zakaria(42, "Zakaria", "The Magician", "zakaria@magician.com", "+21261113909", "Software Engineer", "IT", 7000, "C++");
